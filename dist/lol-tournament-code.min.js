...
!function(){"use strict";function e(e){var r,p;return t.assertArgument(t.isObject(e),1,"Object"),t.assert(e.name,function(){throw new t.RequiredError("name")}),e.map=t.includes(s,t.toNumber(e.map))?e.map:11,e.type=t.includes(a,t.toNumber(e.type))?e.type:6,e.size=t.includes(o,t.toNumber(e.size))?e.size:5,e.spectators=t.includes(n,e.spectators)?e.spectators:"DROPINONLY",e.extra=e.extra||"",p=JSON.stringify({name:e.name,extra:e.extra,password:e.password,report:e.report}),p=new Buffer(p).toString("base64"),r="pvpnet://lol/customgame/joinorcreate/map"+e.map+"/pick"+e.type+"/team"+e.size+"/spec"+e.spectators+"/"+p}var r=require("xp-load"),t=r(require("expandjs"),"XP"),s=[1,2,3,4,8,10,11,12],a=[1,2,4,6],o=[1,2,3,4,5],n=["ALL","NONE","NONE","FRIENDS","DROPINONLY"];t.isBrowser()?(global.LoL=global.LoL||{},global.LoL.tournamentCode=e):module.exports=e}();
...
//# sourceMappingURL=lol-tournament-code.min.map